...
<div class="max-w-7xl m-auto flex justify-between items-center py-4 px-2">
    <div  class="">
        <a href="{{ url('/') }}" class=" relative z-20 block  drop-shadow-[0px_0px_3px_rgba(255,255,255,0.50)]">
            <img src="{{asset('img/LOGO-DENT-LIFE-WEB.webp')}}" class="relative max-w-60 z-10 " alt="LOGO DENT LIFE CLINICA DENTAL">
        </a>
    </div>
    <div class="flex  gap-16 justify-center items-center font-oceanwide">
        <div class="hidden  lg:flex gap-4  lg:text-lg text-white z-10 ">
            <a href="/" class="text-shadow hover:scale-125 ease-in duration-300 ">Inicio</a>
            <a href="/#servicios" class="text-shadow hover:scale-125 ease-in duration-300">Servicios</a>
            <a href="nosotros" class="text-shadow hover:scale-125 ease-in duration-300">Nosotros</a>
            <a href="/#promociones" class="text-shadow hover:scale-125 ease-in duration-300">Promociones</a>
            {{-- <a href="" class="text-shadow hover:scale-125 ease-in duration-300">Blog</a> --}}
        </div>
        <div class=" hidden sm:flex h-10 gap-4 z-10">
            <a href="https://www.facebook.com/DentlifeSjl/" target="_blank" class=" bg-[#b2896b] rounded-lg hover:scale-125 ease-in duration-300" >
            ...
            <a href="https://www.instagram.com/dentlife25/" target="_blank" class=" bg-[#b2896b] rounded-lg hover:scale-125 ease-in duration-300">
            ...
            <a href="https://api.whatsapp.com/send?phone=51999032000" target="_blank"  class=" bg-[#b2896b] rounded-lg p-[2px] hover:scale-125 ease-in duration-300">
            ...
            <a href="https://www.tiktok.com/@evelynladentista" target="_blank"  class=" bg-[#b2896b] rounded-lg p-[4px] hover:scale-125 ease-in duration-300">
        ...
        {{-- btnOpen --}}
        <div class="btn_open_modal lg:hidden cursor-pointer relative z-20">
        ...
        <div class="hidden nav_modal lg:hidden fixed inset-0 z-40 bg-fourth   text-3xl text-white">
            <div class="flex justify-between items-center p-8 mb-32">
                <div  class="">
                    <a href="{{ url('/') }}" class=" relative z-50 block  drop-shadow-[0px_0px_3px_rgba(255,255,255,0.50)]">
                        <img src="{{asset('img/LOGO-DENT-LIFE-WEB.webp')}}" class="relative max-w-60 z-10 " alt="LOGO DENT LIFE CLINICA DENTAL">
                    </a>
                </div>
                <button class="btn_close_modal  hover:scale-125  ease-in duration-300 hover:text-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"><g fill="currentColor"><path d="M16.34 9.322a1 1 0 1 0-1.364-1.463l-2.926 2.728L9.322 7.66A1 1 0 0 0 7.86 9.024l2.728 2.926l-2.927 2.728a1 1 0 1 0 1.364 1.462l2.926-2.727l2.728 2.926a1 1 0 1 0 1.462-1.363l-2.727-2.926z"/><path fill-rule="evenodd" d="M1 12C1 5.925 5.925 1 12 1s11 4.925 11 11s-4.925 11-11 11S1 18.075 1 12m11 9a9 9 0 1 1 0-18a9 9 0 0 1 0 18" clip-rule="evenodd"/></g></svg>
                </button>
            </div>
            <div class="flex flex-col justify-center items-center">

                <a href="/" class="text-shadow hover:scale-125  ease-in duration-300 py-4 hover:text-primary  hover:bg-secondary text-center w-full">Inicio</a>
                <a href="/#servicios" class="text-shadow hover:scale-125 ease-in duration-300 py-4 hover:text-primary hover:bg-secondary text-center w-full">Servicios</a>
                <a href="nosotros" class="text-shadow hover:scale-125 ease-in duration-300 py-4 hover:text-primary hover:bg-secondary text-center w-full">Nosotros</a>
                <a href="/#promociones" class="text-shadow hover:scale-125 ease-in duration-300 py-4 hover:text-primary hover:bg-secondary text-center w-full">Promociones</a>
            </div>
        </div>
    </div>
</div>
